...
void Flutterbird::InitGraphics()
{
	...
	mLayoutFunc = [&](IGraphics* pGraphics) {
		...
		const IText labelText{ 24, themeColorWhite, "SpaceMono-BoldItalic", IText::kStyleNormal, IText::kAlignCenter, IText::kVAlignMiddle };
		const IText infoText{ 24, themeColorWhite, "SpaceMono-BoldItalic", IText::kStyleNormal, IText::kAlignNear, IText::kVAlignMiddle };
