...
def main():
  ...
  plistpath = scriptpath + "/resources/Flutterbird-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Flutterbird-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Flutterbird-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Flutterbird-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Flutterbird-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Flutterbird-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Flutterbird-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Flutterbird.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Flutterbird.iss",inplace=1):
