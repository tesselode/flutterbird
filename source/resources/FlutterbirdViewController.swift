/*
  This is the initial ios app extension view controller, which is referenced by Flutterbird-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class FlutterbirdViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in Flutterbird-iOS-MainInterface.storyboard to custom class: GenericUI  module: FlutterbirdFramework
