...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Flutterbird Demo Installer\n"
      else:
        line="OutputBaseFilename=Flutterbird Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Flutterbird Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Flutterbird installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Flutterbird Demo installer\n"
     else:
       line="SetupWindowTitle=Flutterbird installer\n"
